...
export default function CourseDetailsPage() {
  ...
  // Accordion state for modules (must be before any return)
  ...
  // Fallbacks for missing instructor/category
  ...
  // Enroll button now opens payment modal
  const handleEnroll = () => {
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-0 lg:p-0 overflow-auto w-full">
          {/* Hero Section */}
          <section className="bg-white border-b border-gray-200 px-4 md:px-12 pt-6 pb-8">
            {/* Breadcrumbs */}
